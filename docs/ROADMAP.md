...
- **H10 / DONE:** WebSocket room actions валидируют phase, shape, IDs, bounds, timers, payload limits и replay/duplicate actions для Quiz и Jeopardy; `create_room` учитывает размер signed snapshot, а frontend не скрывает failed room creation.
