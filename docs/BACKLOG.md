...
**P10 Quiz variants — IN_PROGRESS:** функциональная реализация до 4 наборов внутри одной game готова; обязательный variants E2E/regression gate ещё не завершён и не прошёл чистым прогоном.
