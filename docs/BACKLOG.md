...
- **Статус:** `IN_PROGRESS`; завершён targeted `games.py` slice без изменения schema, business rules или production data. Остальные routers/API error facade требуют следующих slices.
